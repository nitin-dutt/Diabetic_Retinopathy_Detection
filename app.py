...
#open some of the unwanted motions 
# 
firebase_config = {
...
# Load model
model_path = 'Diabetic_retinopathy/model/model.h5'
model = load_model(model_path)

remedies_path = 'Diabetic_retinopathy/remedies.json'  # Adjust based on your structure
